...
# Tidy up our install for vcpkg
# Remove debug headers because vcpkg isn't a fan
file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/debug/include")

# Move cmake config files to the expected locations
file(
...
file(
  COPY "${CURRENT_PACKAGES_DIR}/debug/lib/cmake"
  DESTINATION "${CURRENT_PACKAGES_DIR}/debug/share/file-windows"
)
...
# Remove file/pcre2test/pcre2grep binaries
file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/bin")
file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/debug/bin")

# Do whatever vcpkg magic happens here. It was suggested in the
# error output for moving cmake config files to the expected location.
vcpkg_cmake_config_fixup()

# Remove the debug/share directory
